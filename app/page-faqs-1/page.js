							...
							<div className="row">
								<div className="col-lg-4 col-md-4 col-sm-6 col-12">
									<div className="card-grid-style-6 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s">
										<div className="grid-6-img"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/market.svg" alt="Agon" /></div>
								...
								<div className="col-lg-4 col-md-4 col-sm-6 col-12">
									<div className="card-grid-style-6 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".3s">
										<div className="grid-6-img"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/consulting.svg" alt="Agon" /></div>
								...
								<div className="col-lg-4 col-md-4 col-sm-6 col-12">
									<div className="card-grid-style-6 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".5s">
										<div className="grid-6-img"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/cognity.svg" alt="Agon" /></div>
										...
										<div className="row">
											<div className="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
												<div className="box-pricing-item hover-up">
													...
													<div>
														<Link href="/#" className="btn btn-black text-body-lead icon-arrow-right-white">Get Started</Link>
													</div>
												</div>
											</div>
							...
							<div className="row">
								<div className="col-lg-3 col-md-6 col-12">
									<div className="card-grid-style-3 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s">
										<div className="grid-3-img"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/user-1.png" alt="Agon" /></div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									<div className="card-grid-style-3 bd-bg-6 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".3s">
										<div className="grid-3-img"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/user-2.png" alt="Agon" /></div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									<div className="card-grid-style-3 bd-bg-10 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".5s">
										<div className="grid-3-img"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/user-3.png" alt="Agon" /></div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									<div className="card-grid-style-3 bd-bg-9 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".7s">
										<div className="grid-3-img"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/user-4.png" alt="Agon" /></div>
