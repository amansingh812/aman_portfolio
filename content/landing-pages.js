...
export const LANDING_PAGES = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', html: 'Shopify starts at about $52 AUD/month (~$624/year) and charges 0.5–2% transaction fees on top of Stripe\'s fees. On $200,000 annual revenue, that is $1,000–$4,500/year going to Shopify forever. A custom-built store has no platform fees beyond hosting.' },
      ...
      { type: 'p', html: '<a href="/wix-vs-custom-website/" class="color-green-900">Wix</a>, <a href="/squarespace-vs-custom-website/" class="color-green-900">Squarespace</a>, and <a href="/webflow-vs-custom-website/" class="color-green-900">Webflow</a> are great tools — but they are not free. Wix business plans run about $21 to $55 AUD/month ($252 to $660/year). Over 5 years that is $1,920 AUD in platform fees, and you never own the site.' },
      ...
      { type: 'h2', text: 'Website hosting costs in Australia: $0 \u2013 $65/month' },
      { type: 'p', html: 'Hosting is the ongoing cost of keeping the site live. For most small business websites it can be genuinely free \u2014 what you pay depends almost entirely on what the site is built with.' },
      { type: 'table', headers: ['If your site is\u2026', 'Monthly (AUD)'], rows: [
        ['A modern static or Next.js build', '$0'],
        ['WordPress on Australian hosting', '$9 \u2013 $65'],
        ['On Wix, Squarespace or Shopify', '$17 \u2013 $575'],
      ]},
      { type: 'p', html: 'Those ranges hide a lot, and some of it costs real money \u2014 introductory hosting rates that renew up to ten times higher, platform fees that never stop, and the question of whether you can move the site at all. <a href="/website-hosting-cost-australia/" class="color-green-900">What website hosting actually costs</a> has the platform-by-platform figures, the renewal traps and the one-year and five-year totals.' },
      { type: 'p', html: 'Every site we build is deployed on a free tier by default \u2014 $0 a month in hosting for most small business sites, with the first year included regardless. You can move to a paid plan or a different host whenever you like, because you own the code.' },
      ...
      { type: 'faq', q: 'How much does a website cost per month?',
        a: 'With a custom build you own, it can be $0 — hosting is free on Vercel for most small business sites and there is no platform fee. Wix and Squarespace charge $15 to $58 a month indefinitely. Our optional Care + SEO plan is $250 a month and cancels with 30 days notice; nothing about the site stops working if you do not take it.' },
      ...
      { type: 'faq', q: 'How much does an e-commerce website cost in Australia?',
        a: 'A custom e-commerce website in Australia costs $4,500–$10,000 AUD depending on the number of products, payment integrations, and custom features. Shopify plans run about $52 to $575 AUD a month depending on tier, with transaction fees on top unless you use Shopify Payments. A custom-built e-commerce store has no monthly platform fees beyond hosting.' },
      { type: 'faq', q: 'Is it cheaper to use Wix or hire a web developer in Australia?',
        a: 'Wix costs about $21–$55/month ($252–$660/year) with template limitations and no code ownership. A professional web developer costs $1,900+ upfront but you own the site forever with no monthly fees. Over 3 years, the total cost is often comparable — but the custom site performs significantly better in SEO and conversions.' },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'faq', q: 'How long to build a website?',
        a: 'Five to seven business days for three to five pages, two to three weeks for up to ten, four to six weeks for e-commerce, and six to twelve weeks for a custom web app. Those are working days from the point content is supplied, not calendar estimates with padding in them.' },
      { type: 'faq', q: 'How long does it take to develop a website?',
        a: 'Development itself is usually the shorter half. A ten-page business site takes roughly one week of build time; the two to three week timeline covers design approval, content, revisions and testing. Projects that run long are almost always waiting on copy or images rather than on code.' },
      { type: 'faq', q: 'How many hours does it take to design a website?',
        a: 'For a three to five page site, roughly 15 to 25 hours of design and 20 to 30 hours of build. Up to ten pages runs closer to 40 to 60 hours total. We quote a fixed price rather than hourly, so the hours are ours to manage — but that is the honest shape of the work if you are comparing against an hourly quote.' },
      { type: 'faq', q: 'How long does it take to build a local business website?',
        a: 'A local business site — tradie, cafe, clinic, agent — is typically three to five pages plus suburb or service pages, so five to seven business days at the small end and two to three weeks with local SEO pages included. Google Business Profile setup happens alongside the build rather than after it.' },
  ...
  ,
  {
    ...
    body: [
      ...
      { type: 'p', html: 'A website has two costs: what you pay to have it built, and what you pay every month afterwards to keep it online and keep it yours. The second is the one nobody puts on a pricing page, and across five years it is usually the larger of the two.' },
      ...
      { type: 'p', html: 'Our column of that sum is short: $800 to build, no monthly fee because you host it yourself, and nothing to pay if you leave because the repository is already yours. The other column depends on who you are comparing us with \u2014 so do the multiplication on whatever quote you are holding. If a provider will not tell you the monthly fee, or cannot say what happens to your site if you stop paying it, that is your answer.' },
      { type: 'p', html: 'The full platform-by-platform breakdown \u2014 what Wix, Squarespace, Shopify and Australian WordPress hosts actually charge, and which renewal prices jump \u2014 is on <a href="/website-hosting-cost-australia/" class="color-green-900">what website hosting costs</a>. For what drives the build price rather than the running cost, see <a href="/how-much-does-a-website-cost-australia/" class="color-green-900">what a website costs in Australia</a>.' },
  ...
  {
    slug: 'website-hosting-cost-australia',
    metaTitle: 'How Much Does Website Hosting Cost? (Australia, 2026)',
    metaDescription:
      'What website hosting actually costs in Australia: per month, per year, free options, and every platform compared in AUD. Checked September 2026.',
    eyebrow: 'Australia · 2026',
    h1: 'How much does website hosting cost?',
    lead:
      'Short answer: $0 to about $65 AUD a month for a small business website, and a large share of Australian businesses are paying at the top of that range for something they could get free. Here is every number, checked in September 2026.',
    schemaType: 'Article',
    ...
    related: [
      ...
      { href: '/pricing/', label: 'All packages and prices' },
      { href: '/wix-vs-custom-website/', label: 'Wix vs a custom website' },
      { href: '/hire-website-builder/', label: 'Hire someone to build a website' },
    ],
    body: [
      { type: 'h2', text: 'Quick answer' },
      { type: 'p', html: 'For a typical Australian small business website, hosting costs <strong>$0 to $65 AUD per month</strong>. Where you land depends almost entirely on what the site is built with, not on how good it is.' },
      { type: 'table',
        headers: ['If your site is…', 'Monthly (AUD)', 'Yearly (AUD)'],
        rows: [
          ['A modern static or Next.js build', '$0', '$0'],
          ['WordPress on Australian shared hosting', '$9 - $65', '$108 - $780'],
          ['Built on Wix', '$21 - $55', '$252 - $660'],
          ['Built on Squarespace', '$17 - $62', '$204 - $744'],
          ['A Shopify store', '$52 - $575', '$624 - $6,900'],
          ['On AWS or a managed VPS', '$50 - $200+', '$600 - $2,400+'],
        ]
      },
      { type: 'p', html: 'Everything below breaks those numbers down. All figures are AUD and were checked in <strong>September 2026</strong> — platform pricing changes, so treat them as a guide and check the provider before you commit.' },

      { type: 'h2', text: 'Website hosting cost per month' },
      { type: 'p', html: 'The honest version is that "hosting" now means two different things, and conflating them is why people get confused by the price range.' },
      { type: 'ul', items: [
        '<strong>Hosting in the old sense</strong> — renting server space to put files on. For a static or modern JavaScript site this is genuinely free at small-business traffic levels, and has been for years.',
        '<strong>A platform subscription</strong> — Wix, Squarespace, Shopify. The hosting is bundled, but you are really paying for the editor, the templates and the right to keep the site switched on. Stop paying and the site goes down.',
      ]},
      { type: 'p', html: 'That distinction is the whole game. A $50 a month Squarespace bill is not $50 of hosting. It is a few cents of hosting and $50 of software rental.' },

      { type: 'h2', text: 'Website hosting cost per year' },
      { type: 'p', html: 'Multiply by twelve, but watch for two things that catch people out.' },
      { type: 'p', html: '<strong>Annual billing discounts.</strong> Most platforms cut 20-30% for paying yearly. Squarespace Business is about $40/month billed monthly and about $28/month billed annually — roughly $144 a year difference for the same product.' },
      { type: 'p', html: '<strong>Introductory pricing that expires.</strong> This is the big one in Australian shared hosting, and it is covered in the WordPress section below.' },

      { type: 'h2', text: 'Can you host a website for free?' },
      { type: 'p', html: '<strong>Yes — properly free, not a trial.</strong> If your site is a static build or a modern framework like Next.js, Vercel and Cloudflare Pages both host it at no cost, with SSL, a global CDN and automatic deployments included.' },
      { type: 'p', html: 'This is not a loophole or a downgrade. It is how a large share of the modern web is served. The free tiers are generous enough that most small business sites will never approach the limits — Cloudflare Pages, for instance, allows 500 builds a month with unlimited static requests and unlimited bandwidth, no card required.' },
      { type: 'p', html: 'What free hosting cannot do is run WordPress, or anything else that needs a database and PHP running constantly. That is the real reason most Australian small businesses pay for hosting: not that hosting costs money, but that <em>WordPress</em> costs money to host.' },
      { type: 'p', html: 'Every site we build is deployed on a free tier by default, and the first year is included regardless. See <a href="/pricing/" class="color-green-900">pricing</a>.' },

      { type: 'h2', text: 'Website hosting prices by platform' },
      { type: 'h3', text: 'Vercel' },
      { type: 'p', html: '<strong>Free</strong> for personal and small business projects on the Hobby tier. The Pro tier is US$20 per month per seat with 1TB of bandwidth, which almost no small business site needs. Built for Next.js and React. This is where we deploy by default.' },
      { type: 'h3', text: 'Cloudflare Pages' },
      { type: 'p', html: '<strong>Free</strong>, with unlimited bandwidth and unlimited static requests on the free plan and 500 builds a month. Dynamic functions draw on Cloudflare Workers limits (100,000 requests a day free). Excellent for static sites and a genuine alternative to Vercel.' },
      { type: 'h3', text: 'WordPress hosting (Australian providers)' },
      { type: 'p', html: 'Here is where the advertised price and the real price separate, and it is worth knowing before you sign up.' },
      { type: 'table',
        headers: ['Provider', 'Advertised', 'On renewal'],
        rows: [
          ['SiteGround', 'from about $6.99/mo', '$26.99 - $64.99/mo'],
          ['VentraIP (AU-owned)', 'from about $8.95/mo', 'about $11/mo'],
        ]
      },
      { type: 'p', html: '<strong>Read that table twice.</strong> SiteGround\'s introductory rate can rise to nearly ten times itself when the first term ends. That is not a scam — the renewal price is published — but it is disclosed in a way most buyers miss, and it is the single most common unpleasant surprise in Australian small business hosting. VentraIP, an Australian-owned host, renews close to its advertised rate.' },
      { type: 'p', html: 'If you are comparing hosting, <strong>ask for the renewal price, not the first-year price.</strong>' },
      { type: 'h3', text: 'Wix' },
      { type: 'p', html: 'Business-capable plans run roughly <strong>$21 to $55 AUD per month</strong>, with e-commerce on the Business plan at about $46. Hosting is included and cannot be separated from the subscription. You do not get the code.' },
      { type: 'h3', text: 'Squarespace' },
      { type: 'p', html: 'Roughly <strong>$17 to $62 AUD per month</strong> depending on plan and billing cycle. The Business plan is about $40 monthly or $28 on annual billing. Same arrangement as Wix — hosting is bundled, the site is not portable.' },
      { type: 'h3', text: 'Shopify' },
      { type: 'p', html: 'Basic is about <strong>$52 AUD per month</strong> monthly, or about $42 on annual billing. Grow is around $149 and Advanced around $575. Transaction fees apply on top unless you use Shopify Payments. For a store turning over real money the subscription is often the smaller half of what you pay Shopify.' },
      { type: 'h3', text: 'AWS and managed VPS' },
      { type: 'p', html: '<strong>$50 to $200+ AUD per month</strong>, and it needs someone who can administer it. Correct for high-traffic applications and complete overkill for a brochure site. If someone is quoting you AWS for a five-page business website, ask why.' },

      { type: 'h2', text: 'How much does a small business website cost to host?' },
      { type: 'p', html: 'For a typical Australian small business — five to ten pages, a contact form, a few thousand visitors a month — the honest answer is <strong>$0 if the site is built properly, and $10 to $65 a month if it is on WordPress or a page builder.</strong>' },
      { type: 'p', html: 'Over five years that difference is between nothing and roughly $600 to $3,900. It is the single largest avoidable line in the cost of owning a website, and almost nobody raises it at quote stage because the people quoting are usually the people billing it.' },

      { type: 'h2', text: 'What other costs do you have?' },
      { type: 'p', html: 'Hosting is one line of several. Here is the complete picture so nothing surprises you later.' },
      { type: 'table',
        headers: ['Cost', 'Typical AUD', 'Notes'],
        rows: [
          ['Domain (.com.au)', '$10 - $20/year', 'Unavoidable and cheap. Register it in your own name, not your developer\'s.'],
          ['Business email', '$0 - $10/user/month', 'Google Workspace or Microsoft 365. Some hosts include basic mailboxes.'],
          ['Hosting', '$0 - $65/month', 'Covered above. Free for modern static builds.'],
          ['SSL certificate', '$0', 'Free via Let\'s Encrypt and included by every reputable host. If someone charges you for SSL, that is a red flag.'],
          ['Maintenance', '$0 - $250/month', 'Optional. Plugin updates, security patches, content changes. WordPress needs this more than a static site does.'],
          ['Backups', '$0 - $15/month', 'Often bundled. A site in a Git repository is backed up by definition.'],
        ]
      },
      { type: 'p', html: 'Two of those are worth a second look. <strong>SSL should never be a line item</strong> — it has been free since Let\'s Encrypt launched. And <strong>backups are not a product if your site lives in version control</strong>; every change is already a restore point.' },

      { type: 'h2', text: 'What happens if you stop paying for hosting?' },
      { type: 'p', html: 'It depends entirely on what you are paying for, and this is the question people ask too late.' },
      { type: 'ul', items: [
        '<strong>Platform subscription (Wix, Squarespace, Shopify).</strong> The site goes offline, usually within days. Your content sits in their system, viewable but not published, until the account lapses. You cannot export a working site — you can export some content, not the site itself.',
        '<strong>Traditional hosting with your own files.</strong> The site goes offline, but you can take the files and the database elsewhere. Inconvenient, not fatal.',
        '<strong>A site you own, in a repository.</strong> Nothing is lost. The code is on your machine and in your Git account. You redeploy somewhere else, usually in under an hour.',
      ]},
      { type: 'p', html: 'The domain is separate and matters just as much: if the domain lapses, the name can be registered by someone else. Keep it in your own account with auto-renew on, whoever builds your site.' },

      { type: 'h2', text: 'What does it actually mean to own your website?' },
      { type: 'p', html: 'It is used loosely, so here is the concrete test. <strong>You own your website if you can take it to another developer tomorrow without asking anyone\'s permission.</strong> That requires four things:' },
      { type: 'ol', items: [
        '<strong>The domain</strong> is registered in your name, in an account you control.',
        '<strong>The code</strong> is in a repository you own — usually GitHub — and you can download the whole thing.',
        '<strong>The hosting account</strong> is in your name, or the site can be redeployed anywhere without the original builder.',
        '<strong>The content and images</strong> are yours, with no licence tied to a platform.',
      ]},
      { type: 'p', html: 'If any of those sit with the provider rather than you, you are renting. That is a legitimate arrangement if you understand it, and it is what most Australian web companies sell — but it should be a decision rather than something you discover when you try to leave.' },
      { type: 'p', html: 'Everything we build hands over all four on launch day. That is the whole argument, and it is spelled out on the <a href="/affordable-website-design-small-business/" class="color-green-900">five-year cost page</a>.' },

      { type: 'h2', text: 'Can you move your website to another host?' },
      { type: 'p', html: 'Sometimes easily, sometimes not at all.' },
      { type: 'table',
        headers: ['Built on', 'Can you move it?', 'Realistic effort'],
        rows: [
          ['Static / Next.js / React', 'Yes', 'Under an hour. Point the repository at a new host.'],
          ['WordPress', 'Yes', 'Half a day. Files and database migrate; plugins sometimes fight.'],
          ['Shopify', 'Partly', 'Products and customers export. The storefront does not.'],
          ['Wix', 'No', 'Content can be copied out by hand. The site cannot be moved.'],
          ['Squarespace', 'No', 'Partial content export only. The design does not come with you.'],
          ['A proprietary agency CMS', 'No', 'A full rebuild. Ask about this before you sign.'],
        ]
      },
      { type: 'p', html: 'The last row is the one to watch in Australia. Several established web companies here build on their own CMS and host it themselves, which is rarely disclosed at quote stage and means the site can never leave. Ask the question directly: <em>"If I want to move to another developer in two years, what exactly do I take with me?"</em> The platform-by-platform trade-offs are in <a href="/wix-vs-custom-website/" class="color-green-900">Wix vs custom</a> and <a href="/wordpress-vs-custom-website/" class="color-green-900">WordPress vs custom</a>.' },

      { type: 'h2', text: 'Website cost over 1 year' },
      { type: 'p', html: 'A realistic first-year total for a small business site, comparing the two common paths.' },
      { type: 'table',
        headers: ['', 'DIY on a platform', 'Custom build you own'],
        rows: [
          ['Build', '$0 (your time)', '$800 - $1,900'],
          ['Hosting / subscription', '$204 - $660', '$0 (year one included)'],
          ['Domain', '$10 - $20', '$10 - $20'],
          ['SSL', '$0', '$0'],
          ['<strong>Year one total</strong>', '<strong>$214 - $680</strong>', '<strong>$810 - $1,920</strong>'],
        ]
      },
      { type: 'p', html: 'On year one alone the platform wins, and anyone telling you otherwise is selling something. The case for a custom build is not the first year. Build prices are published in full on the <a href="/pricing/" class="color-green-900">pricing page</a>, and <a href="/how-much-does-a-website-cost-australia/" class="color-green-900">what a website costs in Australia</a> covers the wider market.' },

      { type: 'h2', text: 'Website cost over 5 years' },
      { type: 'p', html: 'This is the comparison that matters, and the one nobody puts on a pricing page.' },
      { type: 'table',
        headers: ['', 'DIY on a platform', 'Custom build you own'],
        rows: [
          ['Build', '$0', '$800 - $1,900'],
          ['Hosting / subscription × 5 years', '$1,020 - $3,300', '$0'],
          ['Domain × 5 years', '$50 - $100', '$50 - $100'],
          ['<strong>Five-year total</strong>', '<strong>$1,070 - $3,400</strong>', '<strong>$850 - $2,000</strong>'],
          ['If you want to leave', 'Rebuild from scratch', 'Hand over the repository'],
        ]
      },
      { type: 'p', html: 'The crossover usually lands somewhere in year two or three. After that the custom build is cheaper every month, and it stays yours.' },
      { type: 'p', html: 'Work it out for whatever quote you are holding: <strong>build price + (monthly fee × 60) + the cost of rebuilding if you ever need to leave.</strong> If a provider will not tell you the monthly fee, or cannot say what happens to your site if you stop paying it, you have your answer.' },

      { type: 'h2', text: 'Common questions' },
      { type: 'faq', q: 'How much does it cost to host a website?',
        a: 'For a small business site in Australia, $0 to about $65 AUD a month. A static or Next.js build hosts free on Vercel or Cloudflare Pages indefinitely at normal small business traffic. WordPress needs paid hosting, typically $9 to $65 a month. Wix, Squarespace and Shopify bundle hosting into a subscription of roughly $17 to $575 a month depending on the platform and plan.' },
      { type: 'faq', q: 'How much is website hosting?',
        a: 'Free for modern static sites, and $9 to $65 AUD a month for WordPress on Australian shared hosting. The wide range is mostly about what the site is built with rather than how good the hosting is. Watch renewal pricing: some hosts advertise around $7 a month and renew at $27 to $65.' },
      { type: 'faq', q: 'How much does a website cost per year?',
        a: 'Hosting and domain together run $10 to $800 AUD a year depending on the platform. A custom-built site on a free tier costs about $10 to $20 a year for the domain alone. A Squarespace or Wix site runs $210 to $680 a year. A Shopify store starts around $630 a year before transaction fees.' },
      { type: 'faq', q: 'Can you host a website for free?',
        a: 'Yes. Vercel and Cloudflare Pages both host static and modern JavaScript sites free, with SSL and a global CDN included, and the limits are generous enough that most small business sites never reach them. The catch is that free hosting cannot run WordPress, which needs a database and PHP. So the honest framing is not that hosting costs money — it is that WordPress costs money to host.' },
      { type: 'faq', q: 'How much does it cost to own a website?',
        a: 'If you genuinely own it — domain, code and hosting in your name — the ongoing cost can be as low as $10 to $20 AUD a year for the domain. Everything above that is either a platform subscription, paid hosting for a technology that requires it, or an optional maintenance arrangement. Owning a website is cheap; renting one is not.' },
      { type: 'faq', q: 'What happens if you stop paying for hosting?',
        a: 'On a platform like Wix or Squarespace the site goes offline within days and cannot be exported as a working site. On traditional hosting the site goes offline but you keep the files and can move them. If the site is in a repository you own, nothing is lost and you can redeploy elsewhere in under an hour. Separately, if the domain lapses someone else can register it, so keep the domain in your own account with auto-renew on.' },
      { type: 'faq', q: 'Do websites cost money?',
        a: 'Building one does. Running one need not. The domain is unavoidable at roughly $10 to $20 a year for a .com.au, and SSL is free. Beyond that, whether you pay monthly depends entirely on what the site is built with — a static build costs nothing to keep online, a WordPress or page-builder site costs $10 to $65 a month indefinitely.' },
      { type: 'faq', q: 'How much does website hosting cost in Australia?',
        a: 'Australian-owned hosts like VentraIP start around $8.95 a month and renew close to that. International hosts selling into Australia often advertise from about $6.99 and renew between $26.99 and $64.99. Modern static hosting on Vercel or Cloudflare is free. Always compare the renewal price rather than the introductory one.' },
      { type: 'faq', q: 'What is the cost to run a website per month?',
        a: 'Between $0 and $65 AUD a month for a typical small business site, plus about $1 a month amortised for the domain. Optional extras are business email at $0 to $10 per user and maintenance at $0 to $250 a month. Our Care + SEO plan is $250 a month and is entirely optional — nothing stops working if you do not take it.' },
    ],
  },
