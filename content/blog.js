...
export const BLOG_POSTS = [
  ...
  },
  {
    ...
    excerpt: "We compared the published prices of four Australian web design agencies — including our own — side by side. Real AUD figures, what each includes, and the ownership question almost nobody asks before signing.",
    category: "Comparison",
    date: "2026-08-07",
    readingTime: "9 min read",
  ...
  },
  {
    ...
    excerpt: "The 24 accessibility checks that matter most for NDIS provider websites, what each means in plain English, and how to test your own site for free in about 40 minutes.",
    category: "Checklist",
    date: "2026-08-08",
  ...
  },
  {
    ...
    excerpt: "What an NDIS provider website costs in Australia — real AUD figures, why specialist agencies charge a premium, what accessibility compliance actually costs, and the ongoing fees most quotes leave out.",
    category: "Pricing Guide",
    date: "2026-08-08",
    readingTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "What actually moves rankings for NDIS providers in Australia — Google Business Profile, one page per service, plain-English copy, and why accessibility work doubles as SEO work.",
    category: "SEO",
    date: "2026-08-08",
    readingTime: "9 min read",
